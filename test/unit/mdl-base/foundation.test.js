...
import {MDLBaseFoundation} from '../../../packages/mdl-base';

class FakeFoundation extends MDLBaseFoundation {
  get adapter() {
...
test('cssClasses getter returns an empty object', t => {
  t.deepEqual(MDLBaseFoundation.cssClasses, {});
  t.end();
});

test('strings getter returns an empty object', t => {
  t.deepEqual(MDLBaseFoundation.strings, {});
  t.end();
});

test('numbers getter returns an empty object', t => {
  t.deepEqual(MDLBaseFoundation.numbers, {});
  t.end();
});

test('defaultAdapter getter returns an empty object', t => {
  t.deepEqual(MDLBaseFoundation.defaultAdapter, {});
  t.end();
});
